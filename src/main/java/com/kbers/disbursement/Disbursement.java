...
/**
 * <a href="mailto:joyriver7@gmail.com">Jinxi Hong</a> 2017/5/19 10:44
 */
public class Disbursement {
    ...
    public void getDisbursement(int i) throws IOException, GeneralSecurityException, Exception {
        String value = Constants.getAccountEmailList(i);
        ...
        try{
            ...
            try {
                ...
                String buyergmail=null;
                WebToken(account_list, buyergmail);
            }
        } catch(ArrayIndexOutOfBoundsException e1){

            System.out.println("This Cycle is End");
        }
...
//        System.out.println(profile.getEmailAddress());
        ...
        if(account_list.contains("UK")) {
            ...
            try {
                WebTokenUSNew(gmail, userId, account_list);
            } catch (Exception e) {
                e.printStackTrace();
            ...
            for (Message message : messages) {
                ...
                if (!header.isEmpty()) {
                    ...
                    if (sb3.contains("/")) {
                        ...
                        String ch3 = "https://script.google.com/macros/s/AKfycbwT_lgvjI5iApGszmRkJ_ZEt3xmj4byni38dqV9GImrRGsYxag/exec?method=Total&pa1=" + sb20 + "&pa2=" + sb3 + "&pa3=" + sb1 + "&pa4=" + sb4 + "&pa5=" + sb5 + "&ACC=" + account_list;
            ...
            for (Message message : messages) {
                ...
                if (!header.isEmpty()) {
                    ...
                    String ch3 = "https://script.google" +
                            ...
                            "=Total&pa1=" + sb20 + "&pa2=" + sb3 + "&pa3=" + sb1 + "&pa4=" + sb4 + "&pa5=" + sb5 +
                            "&ACC=" + account_list;
                    System.out.println(Jsoup.connect(ch3).timeout(30000000).ignoreContentType(true).get().text());
    ...
    public void WebTokenUSNew(Gmail gmail, String userId, String account_list) throws IOException, Exception {
        List<Message> messages = gmail.users().messages().list(userId).setQ("From:seller-notification@amazon.com " +
                "subject:(\"Your payment is on the way\") newer_than:6d").execute().getMessages();
        if (messages != null) {
            System.out.println("messages:" + messages);
            for (Message message : messages) {
                String messageid = message.getId();  //  Refund on order
                ...
                if (!header.isEmpty()) {
                    ...
                    sb1 = StringUtils.substringBetween(sb, "(", ")");
                    sb2 = StringUtils.substringBetween(sb, "of ", ".");
                    sb3 = StringUtils.substringBetween(sb, "On ", " we ");
                    sb3 = sb3.trim();
                    System.out.println(ss);
                    System.out.println(account_list);
                    System.out.println("sb1:"+sb1);
                    ...
                    String[] sb33 = sb3.split("/");
                    System.out.println("sb33[0]:"+sb33[0]);
                    System.out.println("sb33[1]"+sb33[1]);
                    System.out.println("sb33[2]"+sb33[2]);
...
//                            .text());
    public void test() throws IOException {
        String ch3 = "https://script.google.com/macros/s/AKfycbwT_lgvjI5iApGszmRkJ_ZEt3xmj4byni38dqV9GImrRGsYxag/exec?method=Total&pa1=311.06 &pa2=05/07/2017&pa3=in 043&pa4=311.06&pa5=31.10&ACC=94IT";
